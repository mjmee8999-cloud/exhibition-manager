              ...
              parts: [
                { inline_data: { mime_type: mimeType, data: base64 } },
                {
                  text:
                    ...
                    "phone은 반드시 '휴대전화(모바일)' 번호만 넣어. " +
                    "'Mobile/Cell/M/H.P/휴대폰/010/+82 10' 등으로 표기된 번호를 우선하고, " +
                    "'Fax/FAX/F/팩스'로 표기된 팩스 번호나 대표전화(Tel)만 있고 휴대전화가 없으면 절대 팩스는 넣지 마. " +
                    "휴대전화가 없으면 phone은 빈 문자열로 둬.",
                },
              ],
            },
          ],
